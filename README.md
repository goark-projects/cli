...
request values. Scalar parameter binding currently supports `string`, `int`,
`int64`, and `bool`; `defaultValue` or `required=false` can be supplied on
