...
import (
	...
	generate "goark.dev/cli/internal/generate/manual"
)

func TestGenerateRegistry_whenSpecHasConfigurations_shouldGenerateDeterministicRegistry(
	t *testing.T,
) {
...
func TestGenerateRegistry_whenSpecInvalid_shouldReturnError(t *testing.T) {
	cases := []generate.RegistrySpec{
		{
			PackageName:    "",
			Configurations: []generate.ConfigurationRegistrationSpec{{Type: "AdminConfiguration"}},
		},
		{
		...
		{
			PackageName:    "generated",
			FunctionName:   "Register-Configurations",
			Configurations: []generate.ConfigurationRegistrationSpec{{Type: "AdminConfiguration"}},
		},
		{PackageName: "generated"},
		{
			PackageName:    "generated",
			Configurations: []generate.ConfigurationRegistrationSpec{{Type: ""}},
		},
		{
			PackageName:    "generated",
			Configurations: []generate.ConfigurationRegistrationSpec{{Type: "bad type"}},
		},
		{
			PackageName:    "generated",
			Configurations: []generate.ConfigurationRegistrationSpec{{Type: "NewConfiguration()"}},
		},
		{
			PackageName:    "generated",
			Configurations: []generate.ConfigurationRegistrationSpec{{Type: "adminConfiguration"}},
		},
		{
			PackageName: "generated",
			Configurations: []generate.ConfigurationRegistrationSpec{
				{Type: "cfg.adminConfiguration"},
			},
		},
		{
			PackageName:    "generated",
			Imports:        []generate.ImportSpec{{Path: "goark.dev/goark"}},
			Configurations: []generate.ConfigurationRegistrationSpec{{Type: "AdminConfiguration"}},
		},
	}
