...
func TestGenerateAnnotations_whenMVCModelAndViewReturnExists_shouldGenerateReturnHandler(
	t *testing.T,
) {
	dir := t.TempDir()
	source := `package app
...
func TestGenerateAnnotations_whenMVCModelParameterAndViewNameReturnExist_shouldRenderModelAndView(
	t *testing.T,
) {
	dir := t.TempDir()
	source := `package app
...
func TestGenerateAnnotations_whenMVCModelParameterAndNoReturnExist_shouldInferViewName(
	t *testing.T,
) {
	dir := t.TempDir()
	source := `package app
