...
const completionCommands = "help version new run build test install vet list fix generate clean tasks task graph sync tools tool codegen info go completion"
